...
static public class InventoryEvent
{
    ...
    public readonly static string ShowMyselfEquip = "InventoryEvent.ShowMyselfEquip";
}
...
{
    public readonly static string ShowOtherPlayerAchievementTip = "AchievmentGlobalEvent.ShowOtherPlayerAchievementTip";
}
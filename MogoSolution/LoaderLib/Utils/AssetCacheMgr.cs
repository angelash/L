...
public class AssetCacheMgr
{
    ...
    public static void GetUIInstanceNoCache(string resourceName, Action<String, int, Object> loaded, Action<float> progress = null)
    {
        //GetInstance(resourceName, loaded);
        m_assetMgr.LoadUIAsset(resourceName, (o) =>
        {
    ...
    public static void GetUIInstances(string[] resourcesName, Action<Object[]> loaded)
    {
        if (resourcesName == null || resourcesName.Length == 0)
        {
            if (loaded != null)
        ...
        for (int i = 0; i < resourcesName.Length; i++)
        {
            int index = i;
            string pref = resourcesName[index];
            GetUIInstance(pref, (resource, guid, obj) =>
            {
                objs[index] = obj;
                count++;
                if (count == resourcesName.Length)
    ...
    public static void GetNoCacheInstance(string resourceName, Action<String, int, Object> loaded, Action<float> progress = null)
    {
        m_assetMgr.LoadInstance(resourceName, loaded, progress);
    }

    public static void GetNoCacheInstanceAutoRelease(string resourceName, Action<String, int, Object> loaded)
    {
        GetNoCacheInstance(resourceName, (resource, guid, go) =>
        {
            UnloadAssetbundle(resourceName);
            if (loaded != null)
                loaded(resource, guid, go);
    ...
    /// <param name="priority">加载优先级: High = 1,Normal = 2,Low = 3,Lowest = 4</param>
    public static void GetResource(string resourceName, Action<Object> loaded, Action<float> progress = null, byte priority = 2)
    {
        m_assetMgr.LoadAsset(resourceName, priority, (obj) =>
        {
            if (obj)
            {
    ...
    public static void GetResources(string[] resourcesName, Action<Object[]> loaded, Action<float> progress = null, byte priority = 2)
    {
        if (resourcesName == null || resourcesName.Length == 0)
        {
            if (loaded != null)
    ...
    public static void GetSecondResources(string[] resourcesName, Action<Object[]> loaded, Action<float> progress = null)
    {
        if (resourcesName == null || resourcesName.Length == 0)
        {
            if (loaded != null)
    ...
    public static void GetNoCacheResource(string resourceName, Action<Object> loaded, Action<float> progress = null, byte priority = 2)
    {
        m_assetMgr.LoadAsset(resourceName, priority, loaded, progress);
    }

    public static void GetNoCacheResources(string[] resourcesName, Action<Object[]> loaded, Action<float> progress = null, byte priority = 2)
    {
        if (resourcesName == null || resourcesName.Length == 0)
        {
            if (loaded != null)
    ...
    public static void GetResourceAutoRelease(string resourceName, Action<Object> loaded, Action<float> progress = null, byte priority = 2)
    {
        m_assetMgr.LoadAsset(resourceName, priority, (obj) =>
        {
            UnloadAssetbundle(resourceName);
    ...
    public static void GetResourcesAutoRelease(string[] resourcesName, Action<Object[]> loaded, Action<float> progress = null, byte priority = 2)
    {
    ...
    public static void GetNoCacheResourceAutoRelease(string resourceName, Action<Object> loaded, Action<float> progress = null, byte priority = 2)
    {
        m_assetMgr.LoadAsset(resourceName, priority, (obj) =>
        {
            UnloadAssetbundle(resourceName);
    ...
    public static void GetNoCacheResourcesAutoRelease(string[] resourcesName, Action<Object[]> loaded, Action<float> progress = null, byte priority = 2)
    {
        GetNoCacheResources(resourcesName, (gos) =>
        {
            UnloadAssetbundles(resourcesName);
            if (loaded != null)
                loaded(gos);
    ...
    public static void GetUIResource(string resourceName, Action<Object> loaded, Action<float> progress = null, byte priority = 2)
    {
        m_assetMgr.LoadUIAsset(resourceName, priority, (obj) =>
        {
            if (obj)
            {
                int id = obj.GetInstanceID();
    ...
    public static void GetUIResources(string[] resourcesName, Action<Object[]> loaded, Action<float> progress = null, byte priority = 2)
    {
        if (resourcesName == null || resourcesName.Length == 0)
        {
            if (loaded != null)
    ...
    public static void GetSecondUIResources(string[] resourcesName, Action<Object[]> loaded, Action<float> progress = null)
    {
        if (resourcesName == null || resourcesName.Length == 0)
        {
            if (loaded != null)
...
public interface ILoadAsset
{
    ...
    void LoadAsset(string prefab, byte priority, Action<Object> loaded, Action<float> progress);
    void LoadUIAsset(string prefab, byte priority, Action<Object> loaded, Action<float> progress);

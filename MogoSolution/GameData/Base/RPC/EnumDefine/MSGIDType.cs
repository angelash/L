...
namespace Mogo.RPC
{
    ...
    public enum MissionReq : byte
    {
        ...
        GET_SPAWNPOINT_TOTAL_NUM = 68, //客户端获取关卡总的刷怪点个数
        ...
        MWSY_MISSION_ENTER_TRAINING = 88,

        MWSY_GET_RESETED_TIMES = 220,
        MWSY_RESET_TIMES = 221,
        MSG_GET_PROP_DROPS = 223, //获取可能翻牌出来的道具
        MSG_GET_RANDOM_REWARD = 224,

        MSG_GET_BASE_PERSON = 226, //获取当前场景的玩家数据

        MSG_GET_FUBEN_MISSION = 227 //副本任务
    }

...
namespace Mogo.RPC
{
    public class EntityCellAttachedPluto : Pluto
    {
        public byte[] ServerEncode(CellAttachedInfo info)
        {
            Push(VUInt16.Instance.Encode(MSGIDType.CLIENT_ENTITY_CELL_ATTACHED));
        ...
        protected override void DoDecode(byte[] data, ref int unLen)
        {
            ...
            {
                RPCMsgLogManager.Receive(MSGIDType.CLIENT_ENTITY_CELL_ATTACHED, Arguments);
            }
        }
        ...
        public override void HandleData()
        {
            ...
            EventDispatcher.TriggerEvent(Events.FrameWorkEvent.EntityCellAttached, info);
        }

...
namespace Mogo.RPC
{
    public class OtherEntityPosTeleportPluto : Pluto
    {
        private readonly CellAttachedInfo info = new CellAttachedInfo();

        public byte[] ServerEncode(CellAttachedInfo info)
        {
            Push(VUInt16.Instance.Encode(MSGIDType.CLIENT_OTHER_ENTITY_TELEPORT));
        ...
        protected override void DoDecode(byte[] data, ref int unLen)
        {
            ...
            {
                RPCMsgLogManager.Receive(MSGIDType.CLIENT_OTHER_ENTITY_TELEPORT, Arguments);
            }
        }
        ...
        public override void HandleData()
        {
            ...
            EventDispatcher.TriggerEvent(Events.FrameWorkEvent.OtherEntityPosTeleport, info);
        }

...
public class MenuUIDict 
{
    ...
    public static class MenuUIEvent
    {
        ...
        public const string ENEMYICONUP = "MenuUI_EnemyIconUp";
        ...
        public const string PLAYERINFOBTNTITLEUP = "MenuUI_PlayerInfoBtnTitleUp";

        public const string PACKAGEGRIDUP = "MenuUI_PackageGridUp";
        public const string PACKAGEGRIDUPSIGNUP = "MenuUI_PackageGridSignUp";

        public const string PACKAGESELL2UP = "MenuUI_PacakgeSell2Up";
        public const string PACKAGEBACKUP = "MenuUI_PacakgeBackUp";
        public const string PACKAGESELLUP = "MenuUI_PacakgeSellUp";
        public const string PACKAGESORTUP = "MenuUI_PacakgeSortUp";
        public const string PACKAGERESOLVEUP = "MenuUI_PacakgeSolveUp";
        public const string PACKAGERESMELTUP = "MenuUI_PacakgeSmeltUp";
        ...
        public const string MENUUIBTNSHAREUP = "MenuUI_BtnShareUp";
